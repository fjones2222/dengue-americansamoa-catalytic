...
prevalence.est(tmp, dsgn=as.dsn, d.f=degf(as.dsn), alpha=0.025)
...
prevalence.est(tmp2, dsgn=as.dsn, d.f=degf(as.dsn), alpha=0.025)
tmp3 <- svyby(
      ~sero_binary,
...
prevalence.est(tmp3, dsgn=as.dsn, d.f=degf(as.dsn), alpha=0.025)
...
fig2c <- fig_df_2c%>%
      ...
      geom_tile(aes(fill = Former_location_group),col=NA)+
