...
# ggsave(filename="output/figures/figure1.png", plot=f1,height=3.9,width = 6.5,scale=1.5)
# ggsave(filename="output/figures/figure1.pdf", plot=f1,height=3.9,width = 6.5,scale=1.5)
ggsave(filename="output/figures/figure1_bg.tiff", plot=f1,height=3.9,width = 6.5,scale=1.5,
       bg = "white"
       )
...
ggsave(filename="output/figures/figure3_bg.tiff", plot=f3,
       height = 4.6,width=6.5,scale=1.1,
     bg="white")
...
lambdas <- modelfit %>% spread_draws(lambda[t]) 
...
ggsave(filename = "output/figures/figure4_bg.tiff",
       plot = figure4,
       height = f4_height,
       width = f4_width,
       scale=1.1,
